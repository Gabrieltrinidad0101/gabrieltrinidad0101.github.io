...
export const Project = async ({image,description,title,code,demo,items,isFull,bgWhite,codeAndDemo }) => {
    ...
    >
        ...
        <div className="p-6">
            ...
            {code && <a href={code} role="link" target='_blank' class="mt-2 inline-flex items-center justify-center gap-2 px-3 py-2 space-x-2 text-base text-white transition bg-gray-800 border border-gray-600 focus-visible:ring-yellow-500/80 text-md hover:bg-gray-800 hover:border-gray-900 group max-w-fit rounded-xl hover:text-white focus:outline-none focus-visible:outline-none focus-visible:ring focus-visible:ring-white focus-visible:ring-offset-2 active:bg-black">
    ...
    return (
        <Container id="projects">
            ...
            <div className="grid md:grid-cols-4 gap-4 mt-6">
                <Project 
                    image="https://raw.githubusercontent.com/Gabrieltrinidad0101/DesignCreate/master/frontend/src/assets/images/logo.png" 
                    title="Design Create" 
                    isFull={true}
                    bgWhite={true}
                ...
                />
                <Project 
                    image="https://raw.githubusercontent.com/Gabrieltrinidad0101/Make-Language/master/logo.png" 
                    title="Make Language" 
                    isFull={true}
                ...
                />
                <Project 
                    image="https://gabrieltrinidad0101.github.io/portafolio/img/pathfinding.png" 
                    title="Path Finding" 
